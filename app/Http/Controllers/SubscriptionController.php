...
class SubscriptionController extends Controller
{
    ...
    public function _1580006382854(Request $request)
    {
        return SystemController::__store(Subscription::class,$request);
    }
    //chamada de metodo sem redirect
    public function _store(Request $request)
    {
        return $this->_1580006382854($request);
    }
    public function store(Request $request)
    {
        ...
        if ( $return[0] == 'error' )
        {
            return redirect()->back()->with('message','Ocorreu um erro #1580006382854 .');
        }
